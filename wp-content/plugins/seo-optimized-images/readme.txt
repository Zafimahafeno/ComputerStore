...
Tags:               optimize images, seo for images, alt text, alt title, seo friendly images 
...
[Upgrade to the Seo Optimized Images Pro Version &raquo;](http://webriti.com/seo-optimized-images)
...
= 2.0 =
1. Fixed warning issues and added freemius directory.
= 1.9 =
1. Update readme.
= 1.8 =
1. Update string.
...
OptionTree Font:
Copyright:  (c) Derek Herman
License:    GNU General Public License v2.0
Source:     https://github.com/valendesigns/option-tree/blob/master/assets/css/ot-admin.css