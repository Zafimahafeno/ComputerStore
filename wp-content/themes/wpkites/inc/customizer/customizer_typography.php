...
$wp_customize->add_section('local_google_font',
	array(
		'title' => esc_html__('Performance(Google Font)', 'wpkites'),
		'panel' => 'wpkites_typography_setting',
		'priority' => 1
	));


$wp_customize->add_setting('wpkites_enable_local_google_font',
	array(
		'default' => true,
		'sanitize_callback' => 'wpkites_sanitize_checkbox',
	)
);
$wp_customize->add_control(new WPKites_Toggle_Control( $wp_customize, 'wpkites_enable_local_google_font',
	array(
		'label' => esc_html__('Load Google Fonts Locally?', 'wpkites'),
		'type' => 'toggle',
